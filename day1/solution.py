...
def find_nums_2020(
    ...
    """Returns `count` numbers from `input_nums` that sum to GOAL_NUM"""
...
def products_from_2020(filename: str,) -> Tuple[int, ...]:
    """Returns products of the 2 and 3 num sets in filename that sum to 2020"""
